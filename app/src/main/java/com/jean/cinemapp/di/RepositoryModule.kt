...
import com.jean.cinemapp.data.repository.movie.MovieDetailRepositoryImpl
...
object RepositoryModule {
    ...
    @Singleton
    @Provides
    fun provideMovieDetailRepository(movieDetailRemoteDataSource: MovieDetailRemoteDataSource, movieDetailLocalDataSource: MovieDetailLocalDataSource): MovieDetailRepository =
